...
import {MongoPermissionSetManager} from "./mongo-permission-set/mongo-permission-set.manager";
...
@Injectable()
export class PermissionSetManager implements IWorkspaceManager {
    constructor(private permissionSetManager: MongoPermissionSetManager) {
    }
